...
from lreid.datasets.get_data_loaders import build_data_loaders
...
def main_worker(args,cfg):
    ...
    if 1==args.setting:
        #training_set = ['cuhk03',  'cuhk_sysu','dukemtmc', 'msmt17', 'cuhk03']
    ...
    all_train_sets, all_test_only_sets ,_= build_data_loaders(args, training_set, testing_only_set)
...
def train_next(cfg,args, all_train_sets, all_test_only_sets,set_index, model,out_channel,writer):
    ...
    for epoch in range(0, args.epochs):
        ...
        if ((epoch + 1) % args.eval_epoch== 0):
            ...
            #print('Finished epoch {:3d}  {}  mAP: {:5.1%}'.format(epoch, name, mAP))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--setting', type=int, default=1,choices=[1,2],help="training setting")
