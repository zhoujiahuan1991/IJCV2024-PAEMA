...
class IncrementalSamples4cuhk03(IncrementalPersonReIDSamples):
    ...
    def __init__(self, datasets_root, relabel=True, combineall=False, split_id=0, cuhk03_labeled=True,
        ...
        self.split_classic_det_json_path = osp.join(
            '/home/liqiwei/code/LReID/cuhk03', 'splits_classic_detected.json'
        )
        self.split_classic_lab_json_path = osp.join(
            '/home/liqiwei/code/LReID/cuhk03', 'splits_classic_labeled.json'
        )

        self.split_new_det_json_path = osp.join(
            '/home/liqiwei/code/LReID/cuhk03', 'splits_new_detected.json'
        )
        self.split_new_lab_json_path = osp.join(
            '/home/liqiwei/code/LReID/cuhk03', 'splits_new_labeled.json'
        )
